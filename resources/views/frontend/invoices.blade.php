...
@section('title', 'Invoices - Doccure')
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-center mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <a href="{{ route('invoice.view') }}">#INV-0010</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ route('invoice.view') }}">#INV-0009</a>
                                        </td>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{ route('patient.profile') }}" class="avatar avatar-sm mr-2">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ route('invoice.view') }}">#INV-0008</a>
                                        </td>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{ route('patient.profile') }}" class="avatar avatar-sm mr-2">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ route('invoice.view') }}">#INV-0007</a>
                                        </td>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{ route('patient.profile') }}" class="avatar avatar-sm mr-2">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ route('invoice.view') }}">#INV-0006</a>
                                        </td>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{ route('patient.profile') }}" class="avatar avatar-sm mr-2">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ route('invoice.view') }}">#INV-0005</a>
                                        </td>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{ route('patient.profile') }}" class="avatar avatar-sm mr-2">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ route('invoice.view') }}">#INV-0004</a>
                                        </td>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{ route('patient.profile') }}" class="avatar avatar-sm mr-2">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ route('invoice.view') }}">#INV-0003</a>
                                        </td>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{ route('patient.profile') }}" class="avatar avatar-sm mr-2">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ route('invoice.view') }}">#INV-0002</a>
                                        </td>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{ route('patient.profile') }}" class="avatar avatar-sm mr-2">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ route('invoice.view') }}">#INV-0001</a>
                                        </td>
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="{{ route('patient.profile') }}" class="avatar avatar-sm mr-2">
