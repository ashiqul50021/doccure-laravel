                        ...
                        <div class="card-body">
                            <div class="booking-doc-info">
                                ...
                                <div class="booking-info">
                                    <h4><a href="{{ route('doctor.profile', $doctor->id) }}">Dr.
                                            ...
                                            <ul>
                                                @foreach($dates as $date)
                                                    <li>
                                                        ...
                                                        <span class="slot-date">{{ $date->format('d M') }} <small
                                                                class="slot-year">{{ $date->format('Y') }}</small></span>
                                                    </li>
                                                @endforeach
                                            </ul>
                                        </div>
                                                        ...
                                                        @if($daySchedule)
                                                            ...
                                                            @while($startTime < $endTime)
                                                                <a class="timing" href="javascript:void(0)"
                                                                    onclick="selectSlot(this, '{{ $date->format('Y-m-d') }}', '{{ $startTime->format('H:i') }}')">
