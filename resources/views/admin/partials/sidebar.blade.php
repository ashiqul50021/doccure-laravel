        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="{{ request()->routeIs('admin.product-categories.*') ? 'active' : '' }}">
                    <a href="{{ route('admin.product-categories.index') }}"><i class="fe fe-layout"></i> <span>Product Categories</span></a>
                </li>
                <li class="{{ request()->routeIs('admin.products.*') ? 'active' : '' }}">
                    <a href="{{ route('admin.products.index') }}"><i class="fe fe-shopping-cart"></i> <span>Products</span></a>
                </li>
                <li class="{{ request()->routeIs('admin.advertisements.*') ? 'active' : '' }}">
                    <a href="{{ route('admin.advertisements.index') }}"><i class="fe fe-image"></i> <span>Advertisements</span></a>
                </li>
                <li class="{{ request()->routeIs('admin.transactions') ? 'active' : '' }}">
                    <a href="{{ route('admin.transactions') }}"><i class="fe fe-activity"></i> <span>Transactions</span></a>
                </li>
                ...
                <li class="{{ request()->routeIs('admin.login') ? 'active' : '' }}">
                    <a href="{{ route('admin.login') }}"><i class="fe fe-user-plus"></i> <span>Login</span></a>
                </li>
                <li class="{{ request()->routeIs('admin.register') ? 'active' : '' }}">
                    <a href="{{ route('admin.register') }}"><i class="fe fe-user-plus"></i> <span>Register</span></a>
                </li>
                <li class="{{ request()->routeIs('admin.forgot.password') ? 'active' : '' }}">
                    <a href="{{ route('admin.forgot.password') }}"><i class="fe fe-user-plus"></i> <span>Forgot Password</span></a>
                </li>
            </ul>
        </div>
    </div>
