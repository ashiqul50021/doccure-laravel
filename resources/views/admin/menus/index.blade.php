...
@section('title', 'Menu Manager - Doccure Admin')
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="actions">
                                        ...
                                        <a class="btn btn-sm bg-danger-light" href="{{ route('admin.menus.delete', $menu->id) }}">
                            ...
                            <tr style="background-color: #f9f9f9;">
                                ...
                                <td class="text-right">
                                    <div class="actions">
                                        ...
                                        <a class="btn btn-sm bg-danger-light" href="{{ route('admin.menus.delete', $child->id) }}">
                                            <i class="fe fe-trash"></i> Delete
                                        </a>
                                    </div>
                                </td>
