                ...
                <form action="{{ route('admin.menus.update', $menu->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" {{ $menu->is_active ? 'checked' : '' }}>
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="open_in_new_tab" name="open_in_new_tab" {{ $menu->open_in_new_tab ? 'checked' : '' }}>
                            <label class="custom-control-label" for="open_in_new_tab">Open in New Tab</label>
                        </div>
                    </div>
